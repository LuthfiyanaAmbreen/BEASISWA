    ...
    <div class="container">
        <div class="col-md-12 d-flex justify-content-center">
            <div class="card mt-5 px-3 mb-5" style="width: 50%;">
                ...
                ?>
                <div class="card-body">
                    <form action="index.php?menu=simpan_data" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <a class="btn btn-primary btn-sm" onclick="generateipk()">IPK</a>
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mt-4 mb-2 d-flex justify-content-end">
                            <button type="submit" class="btn btn-primary mx-2" id="daftar" name="daftar" disabled='false'>Daftar</button>
                            <buttton type="reset" class="btn btn-outline-secondary" id="cancel" disabled='false'>Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
